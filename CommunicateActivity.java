...
This module implements functions to bind front-end
components to the backend functionality such as text
fields for message, connection status, send button,
connection button.
...
//        sendEmail();
    ...
    private void sendEmail() {
        SendMail mail = new SendMail("alerthm05@gmail.com", "healthmonitoring247",
                "usama.abdullah425@gmail.com",
                "Temperature increased",
                "Temperature increased of your contact.");
        mail.execute();

        Toast.makeText(getApplication(), "sending email to your contact", Toast.LENGTH_SHORT).show();
        try {
            SmsManager smsManager = SmsManager.getDefault();
            smsManager.sendTextMessage("+923440049489", null, "Person Temperature is greater then 98", null, null);
