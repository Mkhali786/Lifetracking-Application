...
This module implements onCreate, OpenCommunicationsActivity, onOptionsItemSelected,
onBackPressed(), setupView, onCreateViewHolder, onBindViewHolder, updateList
functions for creating bluetooth communication with the devices and saving device name
and mac addresses and holding and binding data and saving updated items names in the list.
